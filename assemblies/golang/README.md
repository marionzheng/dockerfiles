...
实际上，因为Golang执行不需要任何运行时，所以此基础镜像也仅为集成了glibc库的apline基础系统

> docker build -t registry.cn-shenzhen.aliyuncs.com/szcttech/alpine:3.13 .

> docker push registry.cn-shenzhen.aliyuncs.com/szcttech/alpine:3.13
