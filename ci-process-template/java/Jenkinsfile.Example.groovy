...
pipeline {
    ...
    environment {
        // ---- 手动设置变量
        SERVICE_NAME = ""                 // 微服务名
        PROGRAMMING_LANGUAGE = "java"     // 微服务语言
        ...
        // 当其它项目发布流程中需要用到DevOps模版时，即可访问CI_PATH获取需要使用到的部分，此示例只用到整个DevOps模版中的java子目录中的内容
        CI_PATH = "/var/jenkins_home/workspace/common-ci-procress/java"
    }
